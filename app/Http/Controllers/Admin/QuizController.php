...
class QuizController extends Controller
{
    ...
    {
        $quiz = Quiz::with('topTen.user','results.user')->withCount('getQuestions')->find($id) ?? abort(404,'Quiz bulunamadı');
    ...
    {
        $quiz = Quiz::withCount('getQuestions')->find($id) ?? abort(404,'quiz bulunamadı');
